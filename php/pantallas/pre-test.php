...
<label for="pregunta">1. ¿Tiene dolores frecuentes de cabeza?</label>
<select name="p1">
...
<label for="logrado_exitos">10. ¿Consideras que has logrado éxitos en tu vida?</label><br>
<select name="p10">
	<option value="1">SI</option>
	<option value="0">NO</option>
</select>
